...
class GameScreen extends StatefulWidget {
  ...
  GameScreen({required this.roomId, required this.nickname});
...
class _GameScreenState extends State<GameScreen> {
  ...
  void onConnect(StompFrame frame) {
    ...
    stompClient.subscribe(
      ...
      callback: (frame)
      {
        print('현재 돌아온 값은: ${frame.body}');
        print("selected를 출력합니다");
  ...
  void dispose() {
    print('dispose 실행');
    stompClient.send(
        destination:'/pub/${widget.roomId}/dispose',
        body:'${solo}',
        headers: {}
    );
              ...
              Column(
                children: [
                  ElevatedButton(
                    ...
                    child: Text('이건 연결 테스트용 버튼'),
                  ),
                  Text('대기 화면 입니다'), // 조건이 참일 때 추가
                ],
              ),
            if (showResult)
              Column(
