...
public class IntroduceController {
    ...
    public ResponseEntity<?> getMyIntroduce(@RequestHeader("Authorization") String accessToken) {
        try {
            return new ResponseEntity<>(introduceService.getMyIntroduce(accessToken),
                HttpStatus.OK);
    ...
    @PatchMapping
    public ResponseEntity<?> updateMyIntroduce(@RequestHeader("Authorization") String accessToken,
        @RequestBody UpdateMyIntroduceRequestDto updateMyIntroduceRequestDto) {
        try {
